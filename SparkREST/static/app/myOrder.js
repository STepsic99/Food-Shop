...
<div v-if="showOrders">
	...
	<p>*Prikazane su cene sa popustom (3% za srebrne, a 5% za zlatne korisnike)</p><br>
	Prikaži porudžbine:
    				...
    				if(this.searchedName && !this.orders[i].restaurant.name.toLowerCase().includes(this.searchedName.toLowerCase())){
								...
								break;	
										...
										this.orders.splice(i,1);
											...
											control=0;
											break;	
									}else if(this.status==="NEDOSTAVLJENE" && (this.orders[i].status==="Dostavljena" || this.orders[i].status==="Otkazana")){
										this.orders.splice(i,1);
											control=0;
											break;
									}
